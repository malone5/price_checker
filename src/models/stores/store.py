...
class Store(object):
    ...
    def get_by_url_prefix(cls, url_prefix):
        """
        as soon as we find a single store matching the prefix, we return a store object
        """
    ...
    def find_by_url(cls, url):
        ...
        for i in range(0, len(url)+1):
            try:
                ...
                raise StoreErrors.StoreNotFoundException("The URL Prefix used to find the store did not produce results ")